...
LandmarkList mean_shift_dialog::core(NeuronTree nt, QString saveFile)
{
...
//        return(emptylist);
    ...
    //start mean-shift
    cout << "Starting mean shift in mean_shif_dialog.cpp line 75" << endl;
    poss_landmark.clear();
    ...
    {
        windowradius = LList.at(j).radius;
...
//    nt = mTreeList->at(0);
    ...
    QString swc_out_name =  saveFile + "_meanshifted.swc";
